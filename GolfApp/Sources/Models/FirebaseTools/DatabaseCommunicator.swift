...
struct DatabaseCommunicator {
  ...
  static func getCoursesFromFilter(country: Country, provinceState: Province) async throws
    -> [Course]
  {
  ...
  static func getCoursesFromFilter(_ filter: Filters) async throws -> [Course] {
    return try await getCoursesFromFilter(
      country: filter.country, provinceState: filter.province)
  }
