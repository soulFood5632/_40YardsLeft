...
struct StatTable<T: CustomStringConvertible, V: CustomStringConvertible>: View
...
struct DisplayStat<T: CustomStringConvertible, V: CustomStringConvertible>: Identifiable
where T: _FormatSpecifiable {
  let numOfSamples: V?
  let value: T
  let name: String
