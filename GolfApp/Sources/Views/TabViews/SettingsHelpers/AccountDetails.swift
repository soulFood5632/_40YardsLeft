  ...
  var body: some View {
    VStack {
      ...
      TextFieldWithValiditity(
        condition: TextValiditity.emailChecker,
        text: self.$email,
        prompt: "New Email",
        isSecureField: false,
        isValid: self.$validityCheck[0]
      ...
      TextFieldWithValiditity(
        condition: TextValiditity.passwordCheck, text: self.$firstPassword,
        prompt: "Password", isSecureField: true, isValid: self.$validityCheck[1]
      )
      ...
      TextFieldWithValiditity(
        condition: condition, text: self.$passwordCheck, prompt: "Re-Enter Password",
        isSecureField: true, isValid: self.$validityCheck[2]
      )
      .textContentType(.newPassword)
      .textFieldStyle(.roundedBorder)
