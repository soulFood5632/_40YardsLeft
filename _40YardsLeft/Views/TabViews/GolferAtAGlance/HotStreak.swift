...
extension HotStreak {
  ...
  private var isRoundsPlayedHot: ThreeState {
    return IsHot.numOfRounds(
      rounds: self.numberOfRoundsPlayed, days: Self.DAYS_IN_PAST,
      hotThreshold: golfer.roundsPerDay + 0.1, coldThreshold: golfer.roundsPerDay - 0.1)
  }
