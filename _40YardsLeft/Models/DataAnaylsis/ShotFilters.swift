...
struct ShotFilters {
  ...
  static let bunkerShortGame: (Shot) -> Bool = {
    allShortGame($0) && $0.startPosition.lie == .bunker
  }

  static let roughShortGame: (Shot) -> Bool = {
    allShortGame($0) && $0.startPosition.lie == .rough
  }
}
